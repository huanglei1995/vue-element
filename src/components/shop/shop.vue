<template>
  <div v-show="shopHeader" class="shop">
    <div class="header">
        ...
        <div class="close" @click="close()">
          <svg>
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#res-x">
              <svg viewBox="0 0 1024 1024" id="res-x" width="100%" height="100%">
    ...
    <div class="content">
      <div class="tab">
        ...
        <router-link class="tab_item" tag="div" to="/comment"><span class="weilei">评价</span></router-link>
        <router-link class="tab_item" tag="div" to="/seller"><span class="weilei">店铺</span></router-link>
      </div>
